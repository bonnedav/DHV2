...
def init():
    if os.geteuid() == 0:
        print("DON'T RUN DUCKHUNT AS ROOT! It creates an unnecessary security risk. And please, don't try to disable these checks, they're here for a reason.")
        sys.exit(1)
    global _
    ...
    owners = ["138751484517941259", '94822638991454208', '270061265156702208']
    ...
    canards_bye = [_("The duck went away.  ·°'\`'°-.,¸¸.·°'\`"), _("The duck went to another world.  ·°'\`'°-.,¸¸.·°'\`"), _("The duck didn't have time for this.  ·°'\`'°-.,¸¸.·°'\`"), _("The duck left.  ·°'\`'°-.,¸¸.·°'\`"), _("The duck dissipated in space and time.  ·°'\`'°-.,¸¸.·°'\`"), _("The duck left out of boredom.  ·°'\`'°-.,¸¸.·°'\`"), _("The duck doesn't want to be sniped.  ·°'\`'°-.,¸¸.·°'\`"), _("The duck walked up to the lemonade stand.  ·°'\`'°-.,¸¸.·°'\`")]
    ...
    if gray:
        ...
        logger.info("GreyLog Handler set up :)")
    else:
